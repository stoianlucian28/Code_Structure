...
<head>
    ...
    <title>Dashboard - Add Page</title>
    <!-- HEAD // HEAD // HEAD -->
            ...
            <div class="container-fluid">
                ...
                <form action="create.php" method="post" class="admin-form" enctype = "multipart/form-data">
                    ...
                    <div class="mb3">
                        ...
                        <select class="form-select" name="lesson_id" id="select_lesson" aria-label="Default select example">
                    ...
                    <div class="mb3">
                        ...
                        <label class="form-label select-page">Select page number</label>

                        <input type="text" name="pg" value="<?php echo $pg;?>" class="form-control page-num" id="get_page">  
                    ...
                    <button type="submit" name="add-page" class="btn btn-light admin-form-btn">Create</button>
                </form>
