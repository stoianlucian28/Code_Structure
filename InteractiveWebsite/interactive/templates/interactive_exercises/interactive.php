    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top">
            ...
            <div class="interactive-exercise">
                ...
                <h5 class="introduction">Lorem ipsum.</h5>
...
function initiateExercise(){
  ...
  for(let i = 0; i < divs.length; i++){
    ...
    draggableItems.insertAdjacentHTML("beforeend", 
      ...
      `<div class="draggable-zone">
        <div class="draggable" id="${divs[i].divName}" draggable="true" style="background-color:${divs[i].backgroundColor};"></div>
      </div>`
...
function drop(event) {
  ...
  event.target.insertAdjacentHTML("afterbegin", `<div class="${draggableElementData}" style="background-color: ${draggableElement.style.backgroungolor};"></div>`);
