    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top-section">
            ...
            <div class="exercise-question">
                ...
                In this exercise you will have to complete a basic <br>
                algorithm: prepare your breakfast milk and cereals.
                ...
                <ul class="indications">
                  ...
                  <li>
                    You have to drag and drop each box <br>
                    to form the correct order.

                  </li>
                  <li>Lets assume that you put milk first in your cereal bowl.</li>
                  <li>Good luck!</li>
