    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top">
            ...
            <div class="interactive-exercise">
                ...
                Construct a small quick sort partitioning:
...
const draggableItems = document.querySelector(".draggable-container");
...
function initiateExercise(){
  ...
  for(let i = 0; i < divs.length; i++){
    ...
    draggableItems.insertAdjacentHTML("beforeend", 
      ...
      `<div class="draggable-zone">
        <img src="<?php echo BASE_URL . '/interactive/images/quick_sort/interactive_1/';?>${i}.png" class="draggable" id="${divs[i].divName}" draggable="true">
      </div>`
...
function drop(event) {
  ...
  event.target.insertAdjacentHTML("afterbegin", `<div class="${draggableElementData}" style="background-color: ${draggableElement.style.backgroundColor};"></div>`);
...
function verifyExercise(){
    ...
    for(var i = 0; i < alreadydropped.length; i++){
        ...
        if(alreadydropped[i] == droppedid[i]){
