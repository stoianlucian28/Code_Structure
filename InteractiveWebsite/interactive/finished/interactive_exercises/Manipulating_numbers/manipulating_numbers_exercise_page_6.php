    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top-section">
            ...
            <div class="exercise-question">
                ...
                Create an algorithm that correctly announces whether the positive <br> number given as input is a multiple of 66.
                
                </h5>

                <ul class="indications">
                
                 <li>Here is a little hint: we use a nested if statement.</li>
...
const boxArray = [
    ...
    {
        id: "announce",
        text: "n is a multiple of 6"
    },

    {
        id: "input",
        text: "Input n = a positive integer"
    },

    {
        id: "if_m_2",
        text: "if n is a multiple of 2:"
    },

    {
        id: "if_m_3",
        text: "if n is a multiple of 3:"
    }
];
