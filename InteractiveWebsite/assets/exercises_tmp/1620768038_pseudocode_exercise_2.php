    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top-section">
            ...
            <div class="exercise-question">
                ...
                In this exercise you have to arrange the blocks below <br>
                in order to form an instruction.
                
                </h5>

                <ul class="indications">

                  <li>Simply swap the blocks.</li>
                  <li>There is only one answer correct.</li>
                  <li>
                    If you dont't know about if statement, don't worry <br>
                    we will give you a hint: "else" means "otherwise".
                  </li>
