    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top">
            ...
            <div class="interactive-exercise">
                ...
                We have an array that contains 4 numbers: arr[4] = [3,2,1,4], <br>
                put all the necesarry steps in order.
...
function initiateExercise(){
  ...
  for(let i = 0; i < divs.length; i++){
    ...
    draggableItems.insertAdjacentHTML("beforeend", 
      ...
      `<div class="draggable-zone">
        <img src="<?php echo BASE_URL . '/interactive/images/merge_sort/interactive_1/';?>${divs[i].imgName}.png" class="draggable img-fluid" id="${divs[i].imgName}" draggable="true">
      </div>`
...
function drop(event) {
  ...
  event.target.insertAdjacentHTML("afterbegin", `<img src="<?php echo BASE_URL . '/interactive/images/merge_sort/interactive_1/';?>${draggableElementData}.png" class="${draggableElementData} img-fluid"/>`);
