    ...
    <div class="interactive-lesson" id="test-div">
        ...
        <div class="interactive-top-section">
            ...
            <div class="exercise-question">
                ...
                Write in pseudocode the following: <em> clear any apples off the table,
                <br> then put 3 apples on table. After that substract 2 apples and add 1 pear. 
                </em>
                Good luck!
...
const boxArray = [
    ...
    {
        id: "set_1",
        text: "Set apples to 1"
    },

    {
        id: "set_clear",
        text: "Set apples to 0"
    },

    {
        id: "set_substract",
        text: "Substract 2 apples"
    }
