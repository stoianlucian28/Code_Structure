...
function initiateExercise(){
  ...
  for(let i = 0; i < divs.length; i++){
    ...
    draggableItems.insertAdjacentHTML("beforeend", 
      ...
      `<div class="draggable-zone">
        <img src="<?php echo BASE_URL . '/interactive/images/quick_sort/interactive_1/';?>${divs[i].imgName}.png" class="draggable img-fluid" id="${divs[i].imgName}" draggable="true">
      </div>`
...
function drop(event) {
  ...
  event.target.insertAdjacentHTML("afterbegin", `<img src="<?php echo BASE_URL . '/interactive/images/quick_sort/interactive_1/';?>${draggableElementData}.png" class="${draggableElementData} img-fluid"/>`);
