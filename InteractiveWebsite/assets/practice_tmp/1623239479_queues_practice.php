...
const survey = [
    {
        id: 1,
        question: 'Inserting into a queue:',
        choices: ['At the bottom', 'Using insert(n)', 'At the top'],
    ...
    {
        id: 2,
        question: 'Queue insertion complexity is:',
        choices: ['O(1)', 'O(n)', 'O(logn)'],
        correctAnswer: 'O(1)',
        image: null,
        answer: null
    },
    {
        id: 3,
        question: 'The operations of a queue makes it a data strcture type of:',
        choices: ['Insertion and Deletion', 'First-in first-out', 'Binary'],
...

    {
        ...
        choices: ['Binary', 'Recursive', 'Linear'],
