...
const survey = [
    {
        ...
        choices: ['Divide and conqueror', 'Backtracking', 'Sorting backwards'],
        correctAnswer: 'Divide and conqueror',
        image: null,
        answer: null
    },
    {
        id: 2,
        question: 'Merge sort function is to"',
        choices: ['Merge two arrays', 'Divide the array into two halves ', 'Wrong','Wrong'],
        correctAnswer: 'Divide the array into two halves',
        image: null,
        answer: null
    },
    {
        id: 3,
        question: 'Merge soort is:',
        choices: ['Slower for larger lists', 'Quicker for larger lists', 'A linked list algorithm','Used for binary tree search'],
        correctAnswer: 'Quicker for larger lists',
        image: null,
        answer: null
    },

    {
        ...
        choices: ['Optimized', 'Recursive', 'Fast','Slow'],
...
const renderQuestion = (question) => {    
    ...
    question.choices.forEach(choice => {
        ...
        if(survey[question.id - 1].image != null)
            imageContainerEl.innerHTML = `<img src="../interactive/images/practice/merge_sort/${survey[question.id - 1].image}" alt="" class="img-fluid survey-image">`;
